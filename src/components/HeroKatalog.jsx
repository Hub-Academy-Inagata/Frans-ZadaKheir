...
const HeroKatalog = () => {
  return (
    <div className="relative w-full min-h-screen bg-[url('/src/assets/katalog-hero-bg.png')] bg-center bg-cover flex flex-col justify-center items-center">
      <div className="w-[928px] tracking-[2px] text-center text-white font-clashdisplay font-bold text-[70px] leading-[80px] bg-transparent">
        <h1>The Ultimate Destination for Trendy Muslim Outfits</h1>
      </div>
      <div className="w-[928px] tracking-[0.5px] text-[#E8E8E9] text-center text-2xl font-archivo font-normal mb-12">
        <h3>
      ...
      <button className="w-[311px] h-[44px] rounded-lg bg-gradient-to-r from-[#F6CD73] to-[#9C7539] cursor-pointer flex justify-center items-center">
